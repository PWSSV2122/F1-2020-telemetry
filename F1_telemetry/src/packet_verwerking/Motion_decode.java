	...
	public static void decode(byte[] packet) {
		for (int i = 0; i < 22; i++) {
			...
			Motion_car[i] = new packet_struct.Motion.Motion_car(
					...
					ByteBuffer.wrap(new byte[] {packet[Motion.m_worldForwardDirX_[0] + offset], packet[Motion.m_worldForwardDirX_[1] + offset], packet[Motion.m_worldForwardDirX_[2] + offset], packet[Motion.m_worldForwardDirX_[3] + offset]}).order(ByteOrder.LITTLE_ENDIAN).getShort(),
					ByteBuffer.wrap(new byte[] {packet[Motion.m_worldForwardDirY_[0] + offset], packet[Motion.m_worldForwardDirY_[1] + offset], packet[Motion.m_worldForwardDirY_[2] + offset], packet[Motion.m_worldForwardDirY_[3] + offset]}).order(ByteOrder.LITTLE_ENDIAN).getShort(),
					ByteBuffer.wrap(new byte[] {packet[Motion.m_worldForwardDirZ_[0] + offset], packet[Motion.m_worldForwardDirZ_[1] + offset], packet[Motion.m_worldForwardDirZ_[2] + offset], packet[Motion.m_worldForwardDirZ_[3] + offset]}).order(ByteOrder.LITTLE_ENDIAN).getShort(),
					ByteBuffer.wrap(new byte[] {packet[Motion.m_worldRightDirX_[0] + offset], packet[Motion.m_worldRightDirX_[1] + offset], packet[Motion.m_worldRightDirX_[2] + offset], packet[Motion.m_worldRightDirX_[3] + offset]}).order(ByteOrder.LITTLE_ENDIAN).getShort(),
					ByteBuffer.wrap(new byte[] {packet[Motion.m_worldRightDirY_[0] + offset], packet[Motion.m_worldRightDirY_[1] + offset], packet[Motion.m_worldRightDirY_[2] + offset], packet[Motion.m_worldRightDirY_[3] + offset]}).order(ByteOrder.LITTLE_ENDIAN).getShort(),
					ByteBuffer.wrap(new byte[] {packet[Motion.m_worldRightDirZ_[0] + offset], packet[Motion.m_worldRightDirZ_[1] + offset], packet[Motion.m_worldRightDirZ_[2] + offset], packet[Motion.m_worldRightDirZ_[3] + offset]}).order(ByteOrder.LITTLE_ENDIAN).getShort(),
